...
import { createVersion, getSemverIncrements, isPrereleaseOrIncrement, isValidInput, validate, } from './version.js';
export async function promptVersion(options, pkg) {
    ...
    const prompts = [
        {
            ...
            filter: (input) => isValidInput(input)
        ...
        },
        {
            ...
            when: (answers) => (isPrereleaseOrIncrement(answers.customVersion) ||
