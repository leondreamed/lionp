...
test.serial('public-package published on npm registry: should fail when npm registry not pingable', async () => {
...
test.serial('private package: should disable task pinging npm registry', async () => {
	execaStub.createStub([
		{
...
test.serial('external registry: should disable task pinging npm registry', async () => {
	execaStub.createStub([
		{
			command: 'git rev-parse --quiet --verify refs/tags/v2.0.0',
			exitCode: 0,
...
test.serial('should fail when npm version does not match range in `package.json`', async () => {
	execaStub.createStub([
		{
			command: 'npm --version',
			exitCode: 0,
...
test.serial('should fail when yarn version does not match range in `package.json`', async () => {
	execaStub.createStub([
		{
...
test.serial('should fail when user is not authenticated at npm registry', async () => {
	execaStub.createStub([
		{
			command: 'npm whoami',
			exitCode: 0,
...
test.serial('should fail when user is not authenticated at external registry', async () => {
	execaStub.createStub([
		{
...
test.serial('private package: should disable task `verify user is authenticated`', async () => {
	execaStub.createStub([
		{
			command: 'git rev-parse --quiet --verify refs/tags/v2.0.0',
			exitCode: 0,
...
test.serial('should fail when git version does not match range in `package.json`', async () => {
	execaStub.createStub([
		{
			command: 'git version',
			exitCode: 0,
...
test.serial('should fail when git remote does not exists', async () => {
	execaStub.createStub([
		{
...
test.serial('should fail when version is invalid', async () => {
...
test.serial('should fail when version is lower as latest version', async () => {
...
test.serial('should fail when prerelease version of public package without dist tag given', async () => {
...
test.serial('should not fail when prerelease version of public package with dist tag given', async () => {
	execaStub.createStub([
		{
			command: 'git rev-parse --quiet --verify refs/tags/v2.0.0',
			stdout: ''
...
test.serial('should not fail when prerelease version of private package without dist tag given', async () => {
	execaStub.createStub([
		{
			command: 'git rev-parse --quiet --verify refs/tags/v2.0.0',
			stdout: ''
...
test.serial('should fail when git tag already exists', async () => {
	execaStub.createStub([
		{
			command: 'git rev-parse --quiet --verify refs/tags/v2.0.0',
			stdout: 'vvb'
...
test.serial('checks should pass', async () => {
	execaStub.createStub([
		{
			command: 'git rev-parse --quiet --verify refs/tags/v2.0.0',
			stdout: ''
